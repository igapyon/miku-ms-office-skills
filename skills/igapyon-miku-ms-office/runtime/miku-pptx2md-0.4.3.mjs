...
function addUnsupportedSlideCommentDiagnostics(slideRelationships, slidePath, diagnostics) {
...
function parseSlideXml(xml, slidePath, index, notes, slideRelationships, entries, contentTypes, diagnostics) {
